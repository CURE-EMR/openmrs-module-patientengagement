 ...
 */
public class KenyaBirthdayWishesTask extends AbstractTask {
	
	// Logger
	private static final Logger log = LoggerFactory.getLogger(KenyaBirthdayWishesTask.class);
	
	@Override
	public void execute() {
		try {
			Context.getService(PatientEngagementService.class).sendKenyaBirthdayWishes();
